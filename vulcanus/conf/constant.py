...
AI_BATCH_SYNC_CONF_TO_HOST_FROM_DOMAIN = "/conftrace/ai/confs/batch/syncConf"
HOST_CONF_SYNC_STATUS = "/conftrace/host/sync/status/get"
CONF_TRACE_QUERY = "/conftrace/query"
CONF_TRACE_DATA = "/conftrace/data"
DOMAIN_SYNC_DATA = "/conftrace/domain/statistics"
CONF_CHANGE_RECORD = "/conftrace/conf/change/record"
